...
if (isset($_POST['submit']))
{
    ...
    if($bonustype == 1){
        ...
        $message .= "<h3> Bonus Amount :$ {$usdamount} </h3>";
        ...
        $message1 .= "<h3> You sent an email to ". $useremail ."</h3>";
        $message1 .= "<h3> Email Subject: ". $usersubject ."</h3>";
        $message .= "<h3> Bonus Amount :${$usdamount} </h3>";
    ...
    $message1 .= "<h3> You sent an email to ". $useremail ."</h3>";
    $message1 .= "<h3> Email Subject: ". $usersubject ."</h3>";
    $message1 .= "<h3> Bonus Amount :${$usdamount} </h3>";
    $message1 .= '<p>Message Sent</p>';
    $message1 .= "<p>{$usermessage}</p>";
    $message1 .= '</div>';
    $message1 .= "</body></html>";
